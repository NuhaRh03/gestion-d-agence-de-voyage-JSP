...
<%@ page import="java.sql.*" %>
    ...
    <body id="body-pd">
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div>
                    <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">LListeDesVoyageur</span> </a>
                    <div class="nav_list">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2>Moderateur Table</h2>
                        <table "mytable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>AdminID</th>
                                    <th>Full Name</th>
                                ...
                                <% 
                                    try {
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<td><p data-placement=\"top\" data-toggle=\"tooltip\" title=\"Delete\"><button class=\"btn btn-danger btn-xs delete-row\" data-title=\"Delete\" data-toggle=\"modal\" data-target=\"#delete\"><span class=\"glyphicon glyphicon-trash\"></span></button></p></td>");
                                            out.println("</tr>");
                                        out.println("</tr>");
                                        }
