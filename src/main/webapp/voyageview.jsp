...
<%@ page import="models.Voyage" %>
                            ...
                            <tbody>
                                <% 
                                    try {
                                        ...
                                        // Iterate over the result set and display voyages
                                        while (rs.next()) {
                                            int id = rs.getInt("id");
                                            ...
                                            String moyTransport = rs.getString("moy_Transport");
    ...
    <a data-placement="top" data-toggle="tooltip" title="Edit">
        <button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit">
            <span class="glyphicon glyphicon-pencil"></span> <!-- Edit icon -->
        </button>
    </a>
</td>
<td>
    <a data-placement="top" data-toggle="tooltip" title="Delete">
        <button class="btn btn-danger btn-xs delete-row" data-title="Delete" data-toggle="modal" data-target="#delete">
            <span class="glyphicon glyphicon-trash"></span> <!-- Delete icon -->
        </button>
    </a>
</td>
                                        </td>
