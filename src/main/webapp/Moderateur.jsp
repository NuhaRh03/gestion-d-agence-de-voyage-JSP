...
<head>
    ...
    <title>Interface ajouter moderateur</title>
</head>
...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="formvoyage.html" class="nav_link "> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Users</span> </a>
    ...
    <div style="text-align: center;">
        <h3>Moderateur Managament </h3>
    </div>
    <div class="height-100 bg-light">
        <form class="row g-3 needs-validation"  action="InsertModeratorServlet" method="post">
          <div class="col-md-4">
                <label for=" AdminID" class="form-label">Num Moderateur</label>
            ...
            <div class="col-md-4">
                <label for="full_name" class="form-label">Nom Moderateur</label>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="Password" size="40px">
                <div class="valid-feedback">
                    regarder bien!
                </div>
            </div>
          ...
          Accepter les  conditions
                    ...
                    <div class="invalid-feedback">
                        tu dois accepter avant l'envoi.
                    </div>
                </div>
            </div>
            <div class="col-12">
                <button class="btn btn-primary" type="submit">Ajouter Moderateur</button>
            </div>
        </form>
    </div>
    <!--Container Main end-->
